\pgfdeclareshape{2to1MUX}{
  ...
  \foregroundpath{ % border and pin numbers are drawn here
    ...
    % Pin labels
    \pgftext[left,at={\pgfpoint{-4.5mm}{+10mm}}]{\scriptsize $D_0$}
    \pgftext[left,at={\pgfpoint{-4.5mm}{0mm}}]{\scriptsize $D_1$}
    \pgftext[left,at={\pgfpoint{-4.5mm}{-10mm}}]{\scriptsize $S$}
    \pgftext[right,at={\pgfpoint{+4.5mm}{0mm}}]{\scriptsize $Y$}
    % Pin wires
